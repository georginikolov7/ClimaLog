...
map_modules:
	...
	.byte	0x97, 0x56, 0xdc, 0x13, 0x54, 0x2d, 0xbb, 0x4a, 0xa1, 0x3a, 0x7d, 0x99, 0x74, 0xa8, 0xd9, 0x69	// module_uuid: 13dc5697-2d54-4abb-a13a-7d9974a8d969
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module16_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.16	// assembly_name: ClimaLog_App_MAUI
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
	...
	.byte	0xf8, 0x1f, 0x86, 0x56, 0x1b, 0x34, 0x2e, 0x40, 0xb0, 0x5a, 0xfe, 0x10, 0xb9, 0xe2, 0x8a, 0x8e	// module_uuid: 56861ff8-341b-402e-b05a-fe10b9e28a8e
...
map_java:
	...
	.word	0x200000b	// type_token_id
	.ascii	"crc642de27f5aaf3a1da1/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x10	// module_index
	.word	0x200000c	// type_token_id
	.ascii	"crc642de27f5aaf3a1da1/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
